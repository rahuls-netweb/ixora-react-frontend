...
export default function CareerEnquiry() {
    ...
    const data = [
        {
            ...
            View: <MdRemoveRedEye className={styles.iconView} onClick={() => {
    ...
    var form = [];
    for (var i = 0; i <= 10; i++) {
        form.push(<Form.Group className={styles.popFormGroup} controlId="formBasicCheckbox" >
            <Form.Check className={styles.popFormRadioButton} type="radio" label="Ankit Madaan" />
                            ...
                            <div className={styles.careerEnquiries}>
                                ...
                                <Form className={styles.formCareerEnquiries}>
                                    ...
                                    <Form.Group className={styles.formCareerEnquirieSub2}>
                                        <Button className={styles.formShowButton} onClick={handleShow}>
                                            Assign
                                        </Button>
