...
export default function AddPermissionToRoleModel({ role }) {
  ...
  const existingPermissionsSelectedRole = rolesList.find(
    (singleRole) => singleRole.name === role.name
  );

  useEffect(() => {
    if (existingPermissionsSelectedRole && selectedModule) {
      const selectedIds = {};
      existingPermissionsSelectedRole.module_permission[
  ...
  function handleSubmit(e) {
    ...
    const allPermissionIds = rolesList
      .filter((singleRole) => singleRole.name === role.name)
      .map((singleRole) => {
                                  ...
                                  <h6>
                                    ...
                                    {existingPermissionsSelectedRole.module_permission[
                                      ...
                                      const [module, permission] =
                                        existingPermission.name.split("_");
